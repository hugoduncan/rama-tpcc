...
See [this blog post](https://blog.redplanetlabs.com/2026/03/17/rama-matches-cockroachdbs-tpc-c-performance-at-40-less-aws-cost/) for the full results, including detailed latency numbers and an overview on how Rama performs so well.
...
YugabyteDB's "99.8% efficiency" claim is misleading. With 150,000 warehouses and the standard 10 terminals per warehouse, the theoretical maximum is ~1.9M tpmC. Their actual 1,000,000 tpmC is only 52.9% of full terminal capacity. They achieved "99.8% efficiency" by measuring against a reduced workload, and the exact configuration used was never published. By contrast, both the Rama and CockroachDB benchmarks use the full 10 terminals per warehouse.
...
- Download `rama-tpcc-1.0.0.jar` from https://github.com/redplanetlabs/rama-tpcc/releases
...
2. Place [rama-tpcc-1.0.0.jar](https://github.com/redplanetlabs/rama-tpcc/releases) in the same directory as the unpacked Rama release
